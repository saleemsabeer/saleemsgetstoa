...
const NAV_ITEMS = [
  { section: 'Overview', items: [
    { path: '/demo/medspa', label: 'Dashboard', icon: 'grid' },
    { path: '/demo/medspa/checkin', label: 'Check-In', icon: 'clipboard' },
  ]},
  { section: 'Patients', items: [
    { path: '/demo/medspa/patients', label: 'Patients', icon: 'users' },
    { path: '/demo/medspa/schedule', label: 'Schedule', icon: 'calendar' },
    { path: '/demo/medspa/treatments', label: 'Treatment Plans', icon: 'clipboard' },
    { path: '/demo/medspa/charts', label: 'Clinical Charts', icon: 'clipboard' },
    { path: '/demo/medspa/photos', label: 'Before & After', icon: 'heart' },
    { path: '/demo/medspa/waivers', label: 'Consent & Waivers', icon: 'clipboard' },
    { path: '/demo/medspa/aftercare', label: 'Aftercare', icon: 'heart' },
  ]},
  { section: 'Billing', items: [
    { path: '/demo/medspa/memberships', label: 'Memberships', icon: 'users' },
    { path: '/demo/medspa/wallet', label: 'Patient Wallet', icon: 'package' },
    { path: '/demo/medspa/referrals', label: 'Referrals', icon: 'share' },
  ]},
  { section: 'Operations', items: [
    { path: '/demo/medspa/inventory', label: 'Inventory', icon: 'package' },
    { path: '/demo/medspa/retention', label: 'Retention', icon: 'heart' },
    { path: '/demo/medspa/waitlist', label: 'Waitlist', icon: 'calendar' },
    { path: '/demo/medspa/reviews', label: 'Reviews', icon: 'heart' },
  ]},
  { section: 'Marketing', items: [
    { path: '/demo/medspa/inbox', label: 'DM Inbox', icon: 'message' },
    { path: '/demo/medspa/email', label: 'Email', icon: 'mail' },
    { path: '/demo/medspa/texts', label: 'Text Messages', icon: 'message' },
    { path: '/demo/medspa/social', label: 'Social Media', icon: 'share' },
  ]},
  { section: 'Reporting', items: [
    { path: '/demo/medspa/reports', label: 'Reports', icon: 'bar-chart' },
  ]},
  { section: 'System', items: [
    { path: '/demo/medspa/settings', label: 'Settings', icon: 'settings' },
  ]},
];
