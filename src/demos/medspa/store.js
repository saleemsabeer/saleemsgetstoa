...
export function initStore() {
  ...
  set('ms_settings', {
    ...
    tagline: 'Premium Aesthetic Treatments',
...
function seedIfEmpty(d, today) {
  ...
  if (!localStorage.getItem('ms_settings')) {
    set('ms_settings', { businessName: 'Glow Aesthetics', tagline: 'Premium Aesthetic Treatments', email: 'info@yourmedspa.com', phone: '(480) 555-0100' });
  }
