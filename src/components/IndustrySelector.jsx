...
const industries = [
  ...
  { id: 'tacoboys', icon: '🌮', title: 'Restaurant', sub: 'Menu, ordering, loyalty rewards, member portal', preview: "Taco Boy's" },
  { id: 'media4you', icon: '◎', title: 'Agency / Marketing', sub: 'Campaigns, analytics, content, multi-platform', preview: 'Media4You' },
  { id: 'sear', icon: '🔥', title: 'Festival / Events', sub: 'Tickets, merch, check-in, chef profiles', preview: 'SEAR Festival' },
  { id: 'createandsource', icon: '◆', title: 'Sourcing / Ops', sub: 'Client portal, ops dashboard, order tracking', preview: 'Create & Source' },
]
  ...
  return (
    <section style={s.wrap}>
      <div style={{
        ...
        <h1 style={s.h1}>
          I am a{' '}
          <em style={{ fontStyle: 'italic', color: '#D4AF37' }}>...</em>
        </h1>
        <p style={s.sub}>
...
const s = {
  ...
  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 16, maxWidth: 1100, width: '100%' },
  card: { textAlign: 'left', padding: 24, borderRadius: 16, background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(212,175,55,0.1)', transition: 'all 0.4s cubic-bezier(.16,1,.3,1)', cursor: 'pointer' },
  cardIcon: { fontSize: 24, color: '#D4AF37', marginBottom: 12, filter: 'drop-shadow(0 0 8px rgba(212,175,55,0.3))' },
  cardTitle: { fontFamily: "var(--font-display)", fontSize: 16, fontWeight: 600, color: '#F0EDE6', marginBottom: 4 },
  cardSub: { fontSize: 12, lineHeight: 1.5, color: '#908D9A', marginBottom: 12 },
  cardPreview: { fontFamily: "var(--font-mono)", fontSize: 9, letterSpacing: '0.1em', color: '#D4AF3780', textTransform: 'uppercase' },
...
const mini = {
  ...
  btn: { display: 'inline-flex', alignItems: 'center', gap: 6, padding: '8px 14px', borderRadius: 100, border: '1px solid', fontSize: 11, fontWeight: 600, fontFamily: 'var(--font-body)', transition: 'all 0.3s ease', cursor: 'pointer' },
}
